    ...
    <div class="w-full space-y-4">
        <form action="">
            <input
                type="text"
                placeholder="// ..."
                class="bg-slate-800 boder-0 rounded-md w-1/3 p-3 text-white/60 text-xs"
                wire:model.live="search"
            >
        </form>
        @foreach ($threads as $thread)
            <div class="rounded-md bg-gradient-to-r from-slate-800 to-slate-900 hover:to-slate-800">
